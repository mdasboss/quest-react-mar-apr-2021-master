...
function AnimateDifferentValues() {
    ...
    return (
        <React.Fragment>
            ...
            <animated.svg viewBox="0 0 45 44" strokeWidth="2" fill="white" stroke="rgb(45, 55, 71)" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="156" strokeDashoffset={props.x} style={{margin: '20px', width: '80px', height: '80px'}}>
            ...
            <animated.div>{props.number.interpolate( n => n.toFixed( 2 ) )}</animated.div>
        </React.Fragment>
    );
}
